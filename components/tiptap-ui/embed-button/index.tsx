...
import { TrashIcon } from "@/components/tiptap-icons/trash-icon" // Using Trash for consistency with link popover's 'remove' idea, though it just closes here
...
import "@/components/tiptap-ui/embed-button/embed-popover.scss" // Example path
