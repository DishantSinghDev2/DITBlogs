...
CREATE TABLE `User` (
    ...
    `notificationSettingsId` VARCHAR(191) NULL,
...
CREATE TABLE `Seo` (
    ...
    `schemaOrgEnabled` BOOLEAN NOT NULL DEFAULT false,
...
CREATE TABLE `AffiliateLink` (
    ...
    UNIQUE INDEX `AffiliateLink_shortCode_key`(`shortCode`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `NotificationSettings` (
    ...
    `newPost` BOOLEAN NOT NULL DEFAULT true,
    `createdAt` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    `updatedAt` DATETIME(3) NOT NULL,
...
-- AddForeignKey
ALTER TABLE `User` ADD CONSTRAINT `User_notificationSettingsId_fkey` FOREIGN KEY (`notificationSettingsId`) REFERENCES `NotificationSettings`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;
